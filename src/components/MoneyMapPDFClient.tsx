...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 30, paddingBottom: 15, borderBottomWidth: 2, borderColor: '#d97706' },
  ...
  sectionTitle: { fontSize: 10, fontWeight: 700, color: '#d97706', textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 12, paddingBottom: 5, borderBottomWidth: 1, borderColor: '#e5e5e5' },
  ...
  green: { color: '#059669' },
  savingsBox: { padding: 16, backgroundColor: '#ecfdf5', borderRadius: 6, borderWidth: 1, borderColor: '#6ee7b7', textAlign: 'center' },
  ...
  warning: { padding: 12, backgroundColor: '#fef2f2', borderRadius: 6, borderWidth: 1, borderColor: '#fecaca' },
  ...
  stepNum: { width: 22, height: 22, borderRadius: 11, backgroundColor: '#d97706', textAlign: 'center', lineHeight: 22, marginBottom: 6 },
  ...
  tableRowAlt: { flexDirection: 'row', paddingVertical: 4, borderBottomWidth: 0.5, borderColor: '#f3f4f6', backgroundColor: '#f9fafb' },
      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <View style={styles.grid}>
          ...
          <View style={[styles.card, styles.cardHighlight]}>
            ...
            <View style={styles.row}><Text style={styles.label}>Interest Saved</Text><Text style={{ ...styles.value, color: '#059669', fontSize: 14 }}>{usd(result.interestSaved)}</Text></View>
          </View>
        </View>
        ...
        <View style={{ ...styles.section, marginTop: 20 }}>
          ...
          <View style={styles.steps}>
            <View style={styles.step}><Text style={[styles.stepNum, { color: 'white', fontSize: 11 }]}>1</Text><Text style={styles.stepTitle}>Salary Hits HELOC</Text><Text style={styles.stepDesc}>Balance drops instantly</Text></View>
            <View style={styles.step}><Text style={[styles.stepNum, { color: 'white', fontSize: 11 }]}>2</Text><Text style={styles.stepTitle}>Interest Drops</Text><Text style={styles.stepDesc}>Less daily interest</Text></View>
            <View style={styles.step}><Text style={[styles.stepNum, { color: 'white', fontSize: 11 }]}>3</Text><Text style={styles.stepTitle}>Bills Drain Slowly</Text><Text style={styles.stepDesc}>Repeats each paycheck</Text></View>
          </View>
        </View>
        ...
        <Page size="LETTER" style={styles.page}>
          ...
          <View style={styles.section}>
            ...
            <View style={styles.table}>
              ...
              {firstYear.map((m, i) => (
                <View key={m.month} style={i % 2 === 1 ? styles.tableRowAlt : styles.tableRow}>
          ...
          <Text style={styles.footer}>
            UnMortgage by Patriot Pacific | This report is an estimate. Actual results may vary based on rate changes and payment timing.
          </Text>
        </Page>
      )}
    </Document>
